...
curl -i -X POST -H "Content-Type: application/json" http://localhost:8080/memoryRecord/movePage?recordId=88023deb-1734-40b6-87af-2b3ba60227df\&pageId=a637f5d0-3586-48aa-9f32-ad261d91029a
